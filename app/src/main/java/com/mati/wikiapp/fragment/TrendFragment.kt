...
import com.mati.wikiapp.adapter.TrendAdapter
import com.mati.wikiapp.data.item_post
import com.mati.wikiapp.databinding.FragmentTrendBinding

class TrendFragment : Fragment(), ItemEvent {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.viewTrend.layoutManager =
            LinearLayoutManager(context, RecyclerView.VERTICAL, false)
        binding.viewTrend.adapter = myAdapter
    }
